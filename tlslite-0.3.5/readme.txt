...
tlslite version 0.3.5                                     September 16, 2004
...
8  Using TLS Lite with SocketServer
9  Using TLS Lite with asyncore
10 Using TLS Lite with Twisted
...
Lite integrates with httplib, xmlrpclib, SocketServer, asyncore, and Twisted.
...
When used with these, some of the steps are performed for you.  See the
...
different types of authentication.  For example:
...
how you construct it, it will do different types of authentication.  For
example:
